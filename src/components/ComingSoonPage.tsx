  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center px-4">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Newsletter Signup */}
        <div className="mb-16 p-8 bg-white rounded-2xl shadow-lg border border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            <input
              ...
              className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-brand-500 focus:border-transparent outline-none"
            />
            <button className="btn-enhanced-gradient px-6 py-3 whitespace-nowrap">
              Notify Me
            </button>
          </div>
        </div>

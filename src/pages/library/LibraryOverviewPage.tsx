// Leximius Component Library Overview Page
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="bg-gray-900 rounded-2xl p-8 md:p-12 text-center">
        ...
        <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
          Get up and running with Leximius in minutes. Install the package and start using our components right away.
        </p>
        <div className="bg-gray-800 rounded-lg p-4 mb-8 text-left">
          <code className="text-green-400 font-mono">
            npm install @your-org/leximius
          </code>
        </div>
        <Link
